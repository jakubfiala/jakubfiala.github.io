...
var getRenderFunction = exports.getRenderFunction = function getRenderFunction(context, uniformLocations) {
  return function (time, mouseX, mouseY, resolutionX, resolutionY, invert) {
...
var createRenderer = exports.createRenderer = function createRenderer(fragmentShaderSource) {
  ...
  var invert = context.getUniformLocation(shaderProgram, 'invert');
  ...
  var draw = getRenderFunction(context, { resolution: resolution, mouse: mouse, time: time, invert: invert });
